-- =============================================================================
-- BATCH 7: NEW CATEGORIES (BARRIO PREMIUM / LOCAL SERVICES) - CORRECTED
-- =============================================================================
-- Using category='art_direction' to comply with DB constraints.
-- Distinguishing industry in 'description'.
-- =============================================================================

-- TRADES & SERVICES
INSERT INTO demo_prompts (category, description, content, is_active)
VALUES ('art_direction', 'Trades - The Heroic Fixer', '
-- 🚨 CORE DIRECTIVE:
...
INSERT INTO demo_prompts (category, description, content, is_active)
VALUES ('art_direction', 'Trades - BluePrint Authority', '
-- 🚨 CORE DIRECTIVE:
...
INSERT INTO demo_prompts (category, description, content, is_active)
VALUES ('art_direction', 'Trades - Trusted Neighbor', '
-- 🚨 CORE DIRECTIVE:
-- 1. READ "d:\proyectos\hojacero\BIBLIA.md".
-- 2. READ "creative-director-h0.md".
...
-- LOCAL RETAIL
INSERT INTO demo_prompts (category, description, content, is_active)
VALUES ('art_direction', 'Retail - Fresh Market', '
-- 🚨 CORE DIRECTIVE:
-- 1. READ "d:\proyectos\hojacero\BIBLIA.md".
-- 2. READ "creative-director-h0.md".
...
INSERT INTO demo_prompts (category, description, content, is_active)
VALUES ('art_direction', 'Retail - Neon Corner', '
-- 🚨 CORE DIRECTIVE:
-- 1. READ "d:\proyectos\hojacero\BIBLIA.md".
-- 2. READ "creative-director-h0.md".
...
INSERT INTO demo_prompts (category, description, content, is_active)
VALUES ('art_direction', 'Retail - Heritage Shop', '
-- 🚨 CORE DIRECTIVE:
-- 1. READ "d:\proyectos\hojacero\BIBLIA.md".
-- 2. READ "creative-director-h0.md".
...
-- PERSONAL CARE
INSERT INTO demo_prompts (category, description, content, is_active)
VALUES ('art_direction', 'Beauty - Studio Glam', '
-- 🚨 CORE DIRECTIVE:
-- 1. READ "d:\proyectos\hojacero\BIBLIA.md".
-- 2. READ "creative-director-h0.md".
...
INSERT INTO demo_prompts (category, description, content, is_active)
VALUES ('art_direction', 'Beauty - Barber Club', '
-- 🚨 CORE DIRECTIVE:
-- 1. READ "d:\proyectos\hojacero\BIBLIA.md".
-- 2. READ "creative-director-h0.md".
-- 3. OBEY Random Seeds.
...
INSERT INTO demo_prompts (category, description, content, is_active)
VALUES ('art_direction', 'Beauty - Zen Garden', '
-- 🚨 CORE DIRECTIVE:
-- 1. READ "d:\proyectos\hojacero\BIBLIA.md".
-- 2. READ "creative-director-h0.md".
