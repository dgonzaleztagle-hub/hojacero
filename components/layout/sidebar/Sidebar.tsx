...
import { Home, BarChart2, Users, Settings, LogOut, ChevronRight, Activity, Mail, FileText, Database, Lock, Cpu, Target, KanbanSquare, HelpCircle, LayoutDashboard, Rocket, BookOpen, Calendar, Megaphone, Shield, Globe, DollarSign } from 'lucide-react';
...
export default function Sidebar() {
    ...
    const menuItems: { label: string; href: string; icon: any; isBeta?: boolean; badge?: number; badgeColor?: string }[] = [
        ...
        { label: 'TARIFAS', href: '/dashboard/tarifas-marketing', icon: DollarSign },
