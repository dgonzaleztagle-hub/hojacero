    ...
    return (
        <section ref={containerRef} className="h-screen w-full flex flex-col justify-center items-center relative overflow-hidden mix-blend-difference z-10">
            ...
            <div className="absolute bottom-8 left-6 md:left-12 flex flex-col gap-4 z-20">
                ...
                {/* SOCIAL DOCK */}
                <div className="flex items-center gap-4 opacity-50 hover:opacity-100 transition-opacity duration-300" role="navigation" aria-label="Redes sociales">
                    <a href="https://www.instagram.com/hojacero.cl" target="_blank" rel="noopener noreferrer" aria-label="Instagram de HojaCero" className="hover:text-pink-400 hover:scale-110 transition-all">
                    ...
                    <a href="https://www.linkedin.com/company/hojacero" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn de HojaCero" className="hover:text-blue-400 hover:scale-110 transition-all">
                    ...
                    <a href="https://www.facebook.com/share/1TyKsQC3GJ/" target="_blank" rel="noopener noreferrer" aria-label="Facebook de HojaCero" className="hover:text-blue-600 hover:scale-110 transition-all">
                    ...
                    <a href="https://wa.me/56958946617" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp de HojaCero" className="hover:text-green-400 hover:scale-110 transition-all">
