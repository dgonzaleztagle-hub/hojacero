...
import { Mail, MessageCircle, Phone, Instagram, Facebook, Globe, Zap, Copy, Save, Trash2, ExternalLink, CheckCircle2 } from 'lucide-react';
import { getLeadData, getAnalysis } from '@/utils/radar-helpers';

interface ContactStrategyPanelProps {
    selectedLead: any;
    isDark: boolean;
...
export function ContactStrategyPanel({
    selectedLead, isDark, isEditingContact, setIsEditingContact, editData, setEditData,
    isSaving, onUpdateContact, copyToClipboard, generateTemplate, aiTemplate, setAiTemplate,
    isGeneratingTemplate, copiedField, newNote, setNewNote, saveNote, notes, deleteNote,
    isSavingNote, leadActivities
